...
#At first, I read the data from a csv file and attach to the project. 
#The R function attach() Is used to attach the project for ease of accessibility.
...
#Electricity data Density Plot

# will 
willl <- ggplot(data=data, aes(x=will,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(will), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("will") +  
  ylab("Density") + 
  theme(legend.position="none")

#gas 
gasl <- ggplot(data=data, aes(x=gas,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(gas), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("gas") +  
  ylab("Density") + 
  theme(legend.position="none")

#deal 
deall <- ggplot(data=data, aes(x=deal,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(deal), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("deal") +  
  ylab("Density") + 
  theme(legend.position="none")

#meter 
meterl <- ggplot(data=data, aes(x=meter,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(meter), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("meter") +  
  ylab("Density") + 
  theme(legend.position="none")

#please 
pleasel <- ggplot(data=data, aes(x=please,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(please), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("please") +  
  ylab("Density") + 
  theme(legend.position="none")

#attached 
attachedl <- ggplot(data=data, aes(x=attached,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(attached), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("attached") +  
  ylab("Density") + 
  theme(legend.position="none")

#day 
dayl <- ggplot(data=data, aes(x=day,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(day), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("day") +  
  ylab("Density") + 
  theme(legend.position="none")

#only 
onlyl <- ggplot(data=data, aes(x=only,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(only), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("only") +  
  ylab("Density") + 
  theme(legend.position="none")

#http 
httpl <- ggplot(data=data, aes(x=http,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(http), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("http") +  
  ylab("Density") + 
  theme(legend.position="none")

# volume
volumel <- ggplot(data=data, aes(x=volume,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(volume), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("volume") +  
  ylab("Density") + 
  theme(legend.position="none")

#contract 
contractl <- ggplot(data=data, aes(x=contract,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(contract), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("contract") +  
  ylab("Density") + 
  theme(legend.position="none")

#texas 
texasl <- ggplot(data=data, aes(x=texas,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(texas), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("texas") +  
  ylab("Density") + 
  theme(legend.position="none")

#nom 
noml <- ggplot(data=data, aes(x=nom,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(nom), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("nom") +  
  ylab("Density") + 
  theme(legend.position="none")

#questions 
questionsl <- ggplot(data=data, aes(x=questions,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(questions), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("questions") +  
  ylab("Density") + 
  theme(legend.position="none")

#change 
changel <- ggplot(data=data, aes(x=change,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(change), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("change") +  
  ylab("Density") + 
  theme(legend.position="none")

#thanks 
thanksl <- ggplot(data=data, aes(x=thanks,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(thanks), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("thanks") +  
  ylab("Density") + 
  theme(legend.position="none")

#money 
moneyl <- ggplot(data=data, aes(x=money,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(money), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("money") +  
  ylab("Density") + 
  theme(legend.position="none")

#rate 
ratel <- ggplot(data=data, aes(x=rate,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(rate), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("rate") +  
  ylab("Density") + 
  theme(legend.position="none")

#best 
bestl <- ggplot(data=data, aes(x=best,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(best), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("best") +  
  ylab("Density") + 
  theme(legend.position="none")

#houston 
houstonl <- ggplot(data=data, aes(x=houston,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(houston), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("houston") +  
  ylab("Density") + 
  theme(legend.position="none")

#feb 
febl <- ggplot(data=data, aes(x=feb,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(feb), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("feb") +  
  ylab("Density") + 
  theme(legend.position="none")

#prices 
pricesl <- ggplot(data=data, aes(x=prices,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(prices), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("prices") +  
  ylab("Density") + 
  theme(legend.position="none")

#move 
movel <- ggplot(data=data, aes(x=move,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(move), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("move") +  
  ylab("Density") + 
  theme(legend.position="none")

#neon 
neonl <- ggplot(data=data, aes(x=neon,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(neon), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("neon") +  
  ylab("Density") + 
  theme(legend.position="none")

#nor 
norl <- ggplot(data=data, aes(x=nor,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(nor), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("nor") +  
  ylab("Density") + 
  theme(legend.position="none")

#dr 
drl <- ggplot(data=data, aes(x=dr,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(dr), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("dr") +  
  ylab("Density") + 
  theme(legend.position="none")

#z 
zl <- ggplot(data=data, aes(x=z,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(z), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("z") +  
  ylab("Density") + 
  theme(legend.position="none")

#gra 
gral <- ggplot(data=data, aes(x=gra,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(gra), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("gra") +  
  ylab("Density") + 
  theme(legend.position="none")

#rev 
revl <- ggplot(data=data, aes(x=rev,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(rev), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("rev") +  
  ylab("Density") + 
  theme(legend.position="none")

#alt 
altl <- ggplot(data=data, aes(x=alt,colour=Prediction), fill=Prediction)+
  geom_density(alpha=.3) +
  geom_vline(aes(xintercept = mean(alt), colour=Prediction),linetype="dashed",color="grey",size=1)+
  xlab("alt") +  
  ylab("Density") + 
  theme(legend.position="none")
...
qda.fit = qda(Prediction ~ ., data = train)

qda.pred=predict(qda.fit, test)

qda.class = qda.pred$class
table(qda.class,test$Prediction)

qda_correctness=mean(qda.class==test$Prediction)
qda_correctness
...
##Run nomalization on first 30 coulumns of dataset because they are the predictors
...
pred = prediction(prob, data$Prediction)
...
pred2 = prediction(prob2, test$Prediction)
...
#
#will+gas+deal+meter+please+attached+day+only+http+volume+contract+texas+nom+questions+change+thanks+money+rate+best+houston+feb+prices+move+neon+nor+dr+z+gra+rev+alt
#quadratic
#train_model2=glm(Prediction~poly((),2), family = binomial,data = trainVali)
...
#We apply the best subset selection approach on our data set. Although there are other packages to 
#do this but We use the bestglm package in R package to carryout subset selection. We use logistic 
#regression for illustartion. This package is dependent on the leaps package that is used for linear 
#regression but can also be used for logistic regression.

library(leaps)
regfit.full = regsubsets(Prediction~.,data)
summary(regfit.full)

#Asterish indicates that a given variable is included in the corresponding model. 
#From above, the output indicated that the best one-variable model contains thanks.
#Best two-variable model contains only thanks and dr, best three-variable model 
#contains thanks,dr and attached etc.

#We run the above procedure again but set nvmax to 30 variables this time. Parameter nvmax 
#is used to set the maximum number of variables you desire the function to use.
library(leaps)
regfit.full = regsubsets(Prediction~.,data,nvmax = 30)
summary(regfit.full)

#Variable change is the last variable to be added at subset 30. This agrees with our earlier 
#discovery showing change with high p-value, showing it is less significance.(Note: Need to check)

names(summary(regfit.full))

reg.summary=summary(regfit.full)

#The summary() function returns R2, RSS, adjusted R2, Cp, and BIC. We can examine these to try to 
#select the best overall model.

#Above shows the R-square values of all the 30 variables.

#Below we are plot the BIC for all of the models to set the overall best model and indicates 
#model with smallest statistics.
...
#From above, we can see that the model with the smallest BIC close to -2000 is the twenty-two-variable model. 
#Coef can be used to see which coefficient estimates associated with this model.

coef(regfit.full,22)

#The best over model will contain only the variables shown above.

#We will test this by fitting a logistic regression model with only these twenty-two variables and 
#checking the performance of this model.

#will+deal+please+attached+day+only+http+volume+texas+nom+questions+thanks+money+best+feb+prices+move+neon+dr+z+gra+rev+alt
...
#The performance of our model using twenty-two variables only is better than using all the model. 
#We observe a 90% accuracy.
...
#The regsubsets() function will also be used for forward stepwise selection, by 
#adding the parameter method=“forward”.

regfit.full = regsubsets(Prediction~.,data,nvmax = 30, method = "forward")
summary(regfit.full)

#Following the above forward stepwise selection, the best one variable model contains only thanks, 
#and the best two-variable contains thanks and dr and so on. Due to the nature of our data, the result 
#of forward stepwise is similar to what we got with best stepwise.
...
#Following the above backward stepwise selection, the best one variable model contains only thanks, which is
#simlar to our previous results. The best two-variable contains thanks and money which is different from the 
#previous results.
...
#From the above procedure using lasson method, we observed an accurancy of 82.2%. We make a 
#plot of the cv.ridge variable.
...
#The above plot displays the cross-validation error according to the log of lambda. 
#The vertical dash line indictaes that the log of the optimal value of lambda 
#which minimizes the pprediction error. This lamdba value will give the most accuract model.
...
#The prcomp() function runs PCA on our data’s predictor variables. We excluded the response variable. 
#We tell the R function to center and scale our data and then standardize the data. We then displayed 
#the summary.

#The summary call displays the standard deviation (eigenvalues), proportion of variance and the 
#cumulative proportion.

#Below we make a plot of the eigenvalues pf the first 31 PCs and cumulative variance.
...
abline(h = 0.88759, col="blue", lty=5)           #why h = 0.88759?
#legend("topleft", legend=c("Cut-off @ PC11"),
#       col=c("blue"), lty=5, cex=0.6)

#From the procedure above, the first 11 components has an Eigenvalue > 1 and explains almost 90% of variance. 
#We can reduced the dimensionality from 30 to 11 while losing only 10% variance.
...
#In above procedure, we made same plot as before but added some colors corresponding to the 
#stability of the electric grid. This added beauty to the PCA. We used the first two components 
#and we can see some separation between stable and unstable variable.
...
#The above plot shows the CV profile, where we learn the accurancy obtained from the trained 
#model with different latent variables(Lv). The PLS uses a discriminate analysis model for training.

#We use the varImp() function with parameter 25 to display the 25 most important variable from the PLS.

# Compile models and compare performance
plot(varImp(mod1), 25, main = "PLS-DA")

#The above procedure displayed the 25 most important variables given in relative levels (scaled to 
#the range 0 - 100). The response variable has a relative level of 100.

##Moving Beyond Linearity
#In this session, we focus on generalized addictive models only. There are other models that can 
#also be used here but we will limit our scop to GAM.
...
#From the plots above, can see that fitting non-linearity on most of the variables is sufficient, 
#but Non-linearity isn’t sufficint for variables ______.
...
#The variables are "http", "thanks","attached","gas","gra","nom","meter","dr","money","questions" . 
#The number of nodes is 11, residual mean 
#deviance is 0.70 and the misclassification error rate is 18.3%.

#One interesting feature of tree methods is the fact that we can display the tree graphically. 
#We will go ahead to display the tree graphically below.

plot(tree.data)
text(tree.data,pretty = 0)

#We used plot() function to display the tree structure, and the text() function to disply the node labels. 
#The argument pretty=0 is to include the category names of the qualitative predictors rather than displaying 
#a letter for each category. Terminal nodes are stable and unstable.
...
#The above procedure outputs the number of terminal nodes of each tree considered(size), value of 
#cost-complexity parameter used(k), corss-validation error(dev) and method which is misclass. Tree with 
#14 terminal nodes and tree with terminal nodes 11 results in the lowest cross-validation error rate, with 
#704 cross-validation errors.
...
#To prune the tree, We use the prune.misclass() function to obtain the 14-node tree.
...
#Using the pruned tree to carry out prediction on test data gave 82.21% accuracy. The pruning process 
#is expected to produce both an interpretable tree and also improved the classification accuracy in some cases.
